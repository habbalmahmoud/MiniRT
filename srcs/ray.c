 ...
 float intersect_sphere(t_ray ray, t_sp *sphere)
{
    ...
    sphere_utils.c = dot(sphere_utils.oc, sphere_utils.oc) - sphere_utils.r * sphere_utils.r;
    sphere_utils.discriminant = sphere_utils.b * sphere_utils.b - 4 * sphere_utils.a * sphere_utils.c;
    if (sphere_utils.discriminant < 0)
        return -1.0f;
    sphere_utils.sqrt_disc = sqrt(sphere_utils.discriminant);
    sphere_utils.t1 = (-sphere_utils.b - sphere_utils.sqrt_disc) / (2.0f * sphere_utils.a);
    sphere_utils.t2 = (-sphere_utils.b + sphere_utils.sqrt_disc) / (2.0f * sphere_utils.a);
